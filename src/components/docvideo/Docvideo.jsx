...
const Docvideo = () => {
  ...
  return (<>
        ...
        {getDoctor && (<div className="insta_body">
    <div className="insta-main">
      <div className="insta-wrapper">
        <div className="insta-banner">
          <canvas  style={{backgroundColor: '#3372b58a', width: '100%'}}></canvas>
        </div>
        <div className="insta-details">
          <div className="insta-dp">
            <img  width="150" height="150" src={`${BASEURL}/uploads/${getDoctor.imgurl}`} alt=""/>
           
          </div>
          <div className="insta-name">
            <h2> Dr. {getDoctor.name}
          ...
          <div key={index} className="insta-button">
            <div onClick={() => handleOpenModal(index)}>{video.videoname}</div>
          </div>
    ...
    {isOpen && (
        ...
        >
          ...
          >
            ...
            >
              <source src={`${BASEURL}/uploads/${videos[currentVideoIndex].videourl}`} type="video/mp4" />
            ...
            <div style={{ textAlign: 'center', marginTop: '10px' }}>
              ...
              <button onClick={handleCloseModal} style={{ background: '#007bff', color: '#fff', border: 'none', padding: '8px 16px', borderRadius: '5px', cursor: 'pointer',float:'right' }}>Close</button>
            </div>
          </div>
        </div>
      )}
