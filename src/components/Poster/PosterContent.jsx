        ...
        <div className="container-fluid">
          <div className="row">
            <div className="col-md-4">
              <div className="card bg-light mg-l" style={{ width: "260px" }}>
                  ...
                  <div className="row">
                    <div className=" text-center">
                      <div className="profile-image">
                        ...
                        />
                        <div className="name1">{singalDocData.name}</div>
                        <div className="mobilediv1">{singalDocData.mobile}</div>
                        <div className="city1">{singalDocData.city}</div>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="card-footer foot">
                  <div className="text-center ">
                    <div
                      onClick={() => handleSave(posterRef1, "img")}
                      className="btn btn-sm btn-primary m-1"
                    >
                      <i className="fas fa-download"></i> Image
                    </div>
                    <div
                      onClick={() => handleSave(posterRef1)}
                      className="btn btn-sm btn-primary m-1"
                    >
            ...
            <div>
              <div className="card bg-light mg-l" style={{ width: "260px" }}>
                <div className="card-body pt-0 poster-image" ref={posterRef2}>
                  <div style={{ position: "absolute", top: "4%", zIndex: 0 }}>
                    <QRCodeSVG
                      className="qr"
                      size={100}
                      value={`https://qrcode.netcastservice.co.in/dashboard/video/${singalDocData.name}/${id}`}
                    />
                  </div>
                ...
                <div className="card-footer foot">
                  <div className="text-center">
                    <div
                      onClick={() => handleSave2(posterRef2, "img", 500)}
                      className="btn btn-sm btn-primary m-1"
                    >
                      <i className="fas fa-download"></i> Image
                    </div>
                    <div
                      onClick={() => handleSave2(posterRef2)}
                      className="btn btn-sm btn-primary m-1"
                    >
                      <i className="fas fa-download"></i> Pdf
                    </div>
